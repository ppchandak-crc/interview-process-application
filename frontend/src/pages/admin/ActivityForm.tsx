    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2 space-y-6">
          <form id="activity-form" onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6">
        ...
        <div className="col-span-1 space-y-6">
          ...
          <button 
            ...
            form="activity-form"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-6 py-3 rounded-lg font-medium flex items-center justify-center transition-colors shadow-sm"
          >
